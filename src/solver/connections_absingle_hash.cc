...
class ConnectionsABSinglesHashImpl : public Connections {
 public:
  ConnectionsABSinglesHashImpl(
...
constexpr uint8_t ConnectionsABSinglesHashImpl::NOT_CACHED;
constexpr uint8_t ConnectionsABSinglesHashImpl::CACHED;
constexpr uint8_t ConnectionsABSinglesHashImpl::CACHE_OUTDATED;
constexpr uint8_t ConnectionsABSinglesHashImpl::CACHE_LIMIT_EXCEEDED;

ConnectionsABSinglesHashImpl::ConnectionsABSinglesHashImpl(
    Session* const session, AbstractSystem* const abstract_system)
...
void ConnectionsABSinglesHashImpl::clear() {
  n_dets = 0;
  n_dets_prev = 0;
  cache_status.clear();
...
void ConnectionsABSinglesHashImpl::update() {
  n_dets_prev = n_dets;
...
ConnectionsABSinglesHashImpl::get_connections(const int i) {
...
//      Session* const session, AbstractSystem* const abstract_system) {
//    return new ConnectionsABSinglesHashImpl(session, abstract_system);
//  }
